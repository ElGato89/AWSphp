  ...
  <!-- header -->
    ...
    if($_SERVER["REQUEST_METHOD"]=="GET"){
      ...
      if($row = $result->fetch_object()){
          ...
          printf("<p>Are you sure you want to delete the following records?</p>
                  ...
                  </table>", $name, $date, $time, $venue, $price, $name, $date, $time, $venue, $price);
      }else{
      ...
      $con->close();
        ...
        $con = new mysqli (DB_HOST, DB_USER, DB_PASS, DB_NAME);
        $sql = "DELETE FROM upcoming_concert WHERE concert_name = ?";
        ...
        if($stmt->affected_rows> 0){
                printf("<div>
                        Concert Details <b>%s</b> has been deleted!
                        [<a href='concert-details-admin.php'>Back to Concert Details</a>]
                        </div>",$name);
            }else{
                echo "<div>

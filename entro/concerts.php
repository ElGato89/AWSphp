    ...
    <div class="row display_boxflex">
        ...
        <div class="row">
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 margi_bott">
            ...
            <div class="hover_box">
              ...
              <ul class="icon_hu">
                 <h3>Well Done</h3>
                <li><a href="concertdetails.html"><img src="icon/h.png" alt="#"/></a></li>
                 <li><a href="concertdetails.html"><img src="icon/h.png" alt="#"/></a></li>
              </ul>
            </div>
          </div>
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
        <div class="Gallery_text">
          ...
          <p>
            "Welcome to our concert listings page! Explore upcoming shows featuring a diverse range of artists and genres. From stadium tours to intimate gigs, find all the details you need to plan your next live music experience. Book your tickets and immerse yourself in the thrill of unforgettable performances. Let the music take you on a journey!"</p>
          <a href="concertdetails.html">Read More</a>
        </div>
      </div>
    </div>
  </div>

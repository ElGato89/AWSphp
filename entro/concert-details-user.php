...
// Initialize variables with default values or from $_GET array
$sort = isset($_GET["sort"]) ? $_GET["sort"] : "concert_name";
$order = isset($_GET["order"]) ? $_GET["order"] : "ASC";
$date = isset($_GET["date"]) ? $_GET["date"] : "concert_date";
$time = isset($_GET["time"]) ? $_GET["time"] : "concert_time";
$venue = isset($_GET["venue"]) ? $_GET["venue"] : "concert_venue";
$price = isset($_GET["price"]) ? $_GET["price"] : "concert_price";
?>
        ...
        printf("<tr>
            ...
            <td>
                <form action='payment.php' method='POST'>
                    <input type='hidden' name='concert_name' value='%s'>
                    <input type='hidden' name='concert_date' value='%s'>
                    <input type='hidden' name='concert_time' value='%s'>
                    <input type='hidden' name='concert_venue' value='%s'>
                    <input type='hidden' name='concert_price' value='%d'>
